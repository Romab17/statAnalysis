<?php 
	...
	$path_file = "files/";
        ...
        'color' => array (
				...
				$sheet->getStyleByColumnAndRow(2,7)->applyFromArray($style);
				$sheet->setCellValueByColumnAndRow(2,7,85);
...
var data2 = {
  ...
  series: [
    [61, 62, 61, 900, 60, 59,72,60,68,62,63,68],
    [80,85,81,86,83,84,85,86,10,82,80,81],
...
<div class="wrapper">
<div class="inputg" style="margin: 0 auto; text-align: center;margin-top:%;">
